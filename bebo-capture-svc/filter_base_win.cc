...
class PinEnumerator final : public IEnumPins {
 public:
	 explicit PinEnumerator(FilterBase* filter) : filter_(filter), index_(0), ref_count_(1) {}
 ...
 private:
  ...
  ComPtr<FilterBase> filter_;
  volatile long ref_count_;
  size_t index_;
};

FilterBase::FilterBase() : state_(State_Stopped), ref_count_(1) {
}
